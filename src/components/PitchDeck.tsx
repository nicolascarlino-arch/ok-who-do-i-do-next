const childBench = "/images/child-bench.jpg";
const collageRight = "/images/collage-right.jpg";
const collageLeft = "/images/collage_left.jpg";
const collageWalls = "/images/collage-walls.jpg";
const shower = "/images/shower.jpg";
const tvSet = "/images/tv_set.jpg";
const destroyYou = "/images/i-may-destroy-you.jpg";
const babyReindeer = "/images/baby-reindeer.jpg";
const fleabag = "/images/fleabag.jpg";
const seoul = "/images/seoul.jpg";
const mauroImg = "/images/mauro.jpg";
const elenaImg = "/images/elena.jpg";
const jimmyImg = "/images/jimmy.jpg";
const abstractImg = "/images/abstract_skeletal.jpg";
const nanpuBridge = "/images/nanpu_bridge.jpg";
const waterskiChampion = "/images/waterski_champion.jpg";
const waterskiPyramid = "/images/waterski_pyramid.jpg";
const waterskiTeam = "/images/waterski_team.jpg";
const barefooter = "/images/Barefooter.jpg";
const childhoodDock = "/images/childhood-dock.jpg";
    ...
    <div className="pitch-deck">
      ...
      >
        ...
        <div className="text-block bottom-left">
          <p className="emotional-hook">
            ...
            <br />
            <br />
            It&apos;s about the part of him that was let down – and
            won&apos;t let go.
          </p>
        </div>
      </section>
          ...
          <div className="comps-grid">
            <div className="comp-item">
              ...
              <p className="comp-desc">
                Sexual trauma as nonlinear narrative. Healing, consent and
                identity questioned without moralising.
              </p>
            </div>
            ...
            <div className="comp-item">
              ...
              <p className="comp-desc">
                Deeply personal. A confessional into shame, self-destruction
        ...
        <div className="characters-content fade-content">
          ...
          <div className="character-card character-card-full">
            ...
            <p className="character-desc">
              Mauro grew up in Florida&apos;s 1990s barefoot waterski scene –
              a violent, smile-or-drown kind of world. Today he is a high-end
              ...
              – until one memory, buried for 25 years, hits hard enough to
              break the cycle.
            </p>
          ...
          <div className="characters-grid-two">
            <div className="character-card">
              ...
              <p className="character-desc">
                Elena was once an elite barefoot waterski champion, a
                master of pressure and control. For years Mauro thought her
                manic highs were the source of his damage. In truth she was
                the perfect cover. While everyone watched her unravel, he was
                being raped.
              </p>
            </div>
            <div className="character-card">
              ...
              <p className="character-desc">
                ...
                reckless. To Mauro he feels like freedom. But staying close
                to him means nothing stays buried. He does not label what
                they are; he just keeps pushing until Mauro has no choice
      ...
      >
        ...
        <div className="forces-overlay fade-content">
          <h2 className="section-title forces-title">
            Immaterial Forces
          </h2>
          <p className="forces-kicker"></p>
          ...
          <div className="forces-columns">
            ...
            <div className="force-column">
              ...
              <p className="force-desc">
                They are not just settings – they are belief systems. For
                Mauro they offer framework and status, but they also erase
                him. He is an artist without a self, creating for others,
                selling illusion (quite often just lipsticks) delivering
            ...
            <div className="force-column">
              ...
              <p className="force-desc">
                Mauro does not have sex to connect; he does it to feel
                something real – or someone real. It looks like discovery,
                but it is a loop, a failed attempt at defining himself by
            ...
            <div className="force-column">
              ...
              <p className="force-desc">
                Mauro ignores what happened when he was seven, but his body
                does not. It plays out in sex, in shame, in work. When the
                memory returns 25 years later, it dismantles everything he
                thought was true and pushes an already fractured soul to the
                edge of depersonalisation.
              </p>
            </div>
          </div>
        </div>
...
<tbody>
  ...
  <tr>
    ...
    <td>Distraction</td>
    <td>
      Paris. A glossy campaign and an almost-romance frame Mauro as a
      charismatic lead whose problem looks like heartbreak, not history.
    </td>
    <td>Deceptive rom-com / bottle episode</td>
  </tr>
  <tr>
    <td>2</td>
    <td>High Function</td>
    <td>
      A week across shoots, clubs and hook-ups. Mauro is everywhere, always
      performing, until the first crack in his façade slips through.
    </td>
    <td>Ensemble workplace drama</td>
  </tr>
  <tr>
    <td>3</td>
    <td>Rock Bottom</td>
    <td>
      A spiralling job, a suicide attempt and fragmented memories expose that
      something far older is wrong than a breakup or burnout.
    </td>
    <td>Psychological collapse thriller</td>
  </tr>
  ...
  <tr>
    <td rowSpan={3} className="act-label">
      <div className="act-text">
        <span>ACT II </span>
        <span>ILLUSIONS BREAK</span>
        <br />
        <span className="act-tagline">No more hiding from the fracture.</span>
      </div>
      <div className="act-brace" />
    </td>
    <td>4</td>
    <td>Trigger</td>
    <td>
      Back on set, tiny details and Jimmy&apos;s presence keep poking the
      wound. Mauro starts chasing the memory that is chasing him.
    </td>
    <td>Surreal bottle episode</td>
  </tr>
  <tr>
    <td>5</td>
    <td>Cortisol</td>
    <td>
      Lanzarote. Mushrooms, volcanic landscapes and an experimental retreat
      crack his defences wide open while the past finally surfaces.
    </td>
    <td>Hybrid live-action / animation trip</td>
  </tr>
  <tr>
    <td>6</td>
    <td>Dopamine</td>
    <td>
      Mauro enters trauma therapy convinced he can &quot;fix&quot; himself
      quickly. The process is slower, messier and more exposing than he ever
      planned.
    </td>
    <td>Intimate therapy chamber piece</td>
  </tr>

  {/* ACT III – episodes 7–8 */}
  <tr>
    <td rowSpan={2} className="act-label">
      <div className="act-text">
        <span>ACT III </span>
        <span>HEALING QUESTIONED</span>
        <br />
        <span className="act-tagline">
    ...
    <td>Scarring</td>
    <td>
      Mauro confronts institutions and family, chasing justice that may never
      fully arrive and re-opening the cost of speaking.
    </td>
    <td>Confrontation set-piece</td>
  </tr>
  <tr>
    <td>8</td>
    <td>Wounded Healer</td>
    <td>
      The season closes on a quieter, more honest life. Mauro learns to live
      with the fact that recovery is a practice, not a performance.
    </td>
    <td>Still, hopeful resolution</td>
  </tr>
</tbody>
          ...
          <div className="dev-columns">
            <div className="dev-block">
              ...
              <ul>
                ...
                <li>
                  Season world, arcs and structure are locked emotionally
                  and formally.
                </li>
                <li>
            ...
            <div className="dev-block">
              ...
              <ul>
                <li>
                  Finish the remaining 4 scripts and polish the season
                  bible.
                </li>
                <li>
                  Open the material to a writers’ room while protecting
                  the core voice.
                </li>
                <li>
            ...
            <div className="dev-block">
              ...
              <ul>
                ...
                <li>
                  Room to grow form while keeping the emotional
                  architecture intact.
                </li>
              </ul>
            </div>
              ...
              <div className="budget-table">
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>
                        Lean, agile and artist-driven — built for
                        prestige, not overspend
                      </td>
                    </tr>
                    <tr>
                      <td>
                        Open to collaboration on casting, rollout and
              ...
              <div className="budget-table">
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      <td>
                        Co-production ready — open to EU support (CNC,
                        regional funds)
                      </td>
                    </tr>
                    <tr>
                      <td>
                        Organic partnerships with fashion / beauty /
                        music brands
                      </td>
                    </tr>
                  </tbody>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Nightlife / music venues / fashion backstage
                      </td>
                      <td>Mid–High</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        Flashback structures, multi-timelines
                      </td>
                      <td>High</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>
                        Lanzarote landscapes + animated sequences
                      </td>
                      <td>Very High</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        EMDR therapy scenes + minimal locations
                      </td>
                      <td>Mid</td>
                    </tr>
                    <tr>
                      ...
                      <td>Confrontation Set-piece</td>
                      <td>
                        Rooftop, police precinct, stylised city inserts
                      </td>
                      <td>Mid</td>
                    </tr>
                    <tr>
                      ...
                      <td>
                        Therapy space, contained emotional arc
                      </td>
                      <td>Low</td>
                    </tr>
                  </tbody>
            ...
            <div className="ip-quadrants">
              <div className="ip-quadrant ip-top-left">
                ...
                <p>
                  ...
                  <strong>Nicola Scarlino</strong>.
                </p>
                <p>
                  A singular voice — ensuring tonal coherence, emotional
                  truth and visual boldness from script to screen.
                </p>
              </div>
              ...
              <div className="ip-quadrant ip-top-right">
                ...
                <p>
                  100% original material — no adaptation constraints.
                  Built for scalability across seasons, formats and
                  markets.
                </p>
              </div>
              ...
              <div className="ip-quadrant ip-bottom-left">
                ...
                <p>
                  Designed for a network that champions bold,
                  author-driven storytelling.
                </p>
                <p>
                  Encourages narrative risk-taking, cross-genre
                  fluidity, and genuine creative authorship.
                </p>
              </div>
              ...
              <div className="ip-quadrant ip-bottom-right">
                ...
                <p>
                  ...
                  — <strong>without compromising the emotional
                  architecture.</strong>
                </p>
      ...
      >
        ...
        <div className="closing-overlay">
          <div className="closing-text-box">
            ...
            <p>
              When I was a kid, something happened that I buried so deep
              it shaped my whole life without me knowing.
            </p>
            <p>
              At 35, it came back. Not as a flashback — as a fracture.
              Quiet, violent, undeniable.
            </p>
            <p>
              Suddenly, everything made sense. The hunger to be seen. The
              bulimia. The obsession with getting it right. The sex. The
              work. The disconnection. The charm. The collapse.
            </p>
            <p>It wasn’t ambition — it was survival.</p>
            <p>
              I always say I survived twice. Once when I was a child. Once
              when I remembered. The second time nearly killed me.
            </p>
            <p>
              I don’t want applause. I want to show what it feels like
              when your identity is built on something you never asked
              for.
            </p>
            <p>
              When the thing that hurt you most… also made you who you
              are. And you can’t tell if that’s tragic or beautiful.
            </p>
            <p>
              This show doesn’t try to fix that question. It just dares to
              sit in it — and look.
            </p>
          </div>
        </div>
